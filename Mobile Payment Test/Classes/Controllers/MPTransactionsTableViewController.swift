//
//  MPTransactionsTableViewController.swift
//  Mobile Payment Test
//
...
class MPTransactionsTableViewController: MPBaseTableViewController {
    ...
    private var _transactions: [MPTransaction] = MPUtils.transactions
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if let transactionCell = cell as? MPTransactionTableViewCell {
    ...
    private func refundTransaction(_ transaction: MPTransaction) {
