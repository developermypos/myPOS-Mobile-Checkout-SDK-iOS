//
//  MPOrdersTableViewController.swift
//  Mobile Payment Test
//
...
class MPOrdersTableViewController: MPBaseTableViewController {
    ...
    private var _orders: [String] = MPUtils.orders
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if let orderCell = cell as? MPOrderTableViewCell {
